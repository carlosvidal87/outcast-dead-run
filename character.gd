...
const WEAPONS = {
	"blaster-a": {
		...
		"recoil_amount": 0.08,
		"cost": 0,
		"model_path": "res://Weapons Models/blaster-a.glb",
		"sound_shoot": preload("res://Sounds/pistol-shot.mp3"),
		"sound_shoot_offset": 0.15,
		"sound_shoot_db": -10.0,
		"sound_reload": preload("res://Sounds/pistol-reload.mp3"),
		"sound_reload_db": -8.0
	},
	"blaster-d": {
		"name": "Assault Rifle",
		...
		"recoil_amount": 0.05,
		"cost": 1000,
		"model_path": "res://Weapons Models/blaster-d.glb",
		"sound_shoot": preload("res://Sounds/assalt-shot.mp3"),
		"sound_shoot_offset": 0.08,
		"sound_shoot_db": 4.0,
		"sound_reload": preload("res://Sounds/assalt-reload.mp3"),
		"sound_reload_db": -4.0
	},
	"blaster-h": {
		"name": "Shotgun",
		...
		"recoil_amount": 0.2,
		"cost": 1500,
		"model_path": "res://Weapons Models/blaster-h.glb",
		"sound_shoot": preload("res://Sounds/shotgun-shot.mp3"),
		"sound_shoot_db": -6.0,
		"sound_reload": preload("res://Sounds/shotgun-reload.mp3"),
		"sound_reload_db": -2.0
	}
}
...
func _ready() -> void:
	...
	var menu_controller_script = preload("res://menu_controller.gd")
